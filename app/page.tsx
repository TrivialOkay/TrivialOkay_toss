...
const sampleCatalogVersion = "2026-08-fortunes-73-small-grins";
...
function ExamplesScreen({ onBack }: { onBack: () => void }) {
  const examples = [fortunes.find((fortune) => fortune.id === 84), fortunes.find((fortune) => fortune.id === 86), fortunes.find((fortune) => fortune.id === 93)].filter((fortune): fortune is (typeof fortunes)[number] => Boolean(fortune));
  return (
