...
const sampleCatalogVersion = "2026-08-fortunes-47-tiny-wins";
...
function ExamplesScreen({ onBack }: { onBack: () => void }) {
  const examples = [fortunes.find((fortune) => fortune.id === 62), fortunes.find((fortune) => fortune.id === 63), fortunes.find((fortune) => fortune.id === 66)].filter((fortune): fortune is (typeof fortunes)[number] => Boolean(fortune));
  return (
