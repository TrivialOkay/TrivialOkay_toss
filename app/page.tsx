...
const sampleCatalogVersion = "2026-08-fortunes-30-character-poses";
...
function ExamplesScreen({ onBack }: { onBack: () => void }) {
  const examples = [fortunes.find((fortune) => fortune.id === 46), fortunes.find((fortune) => fortune.id === 47), fortunes.find((fortune) => fortune.id === 50)].filter((fortune): fortune is (typeof fortunes)[number] => Boolean(fortune));
  return (
